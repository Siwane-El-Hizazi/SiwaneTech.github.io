...
Casablanca = City("Casablanca ,IQ","-7.603869","33.589886")

Rabat = City("Rabat, IQ","-6.814949","34.014540")



limit = 5
URL = BASE_URL + "lat=" + Casablanca.lat + "&lon=" + Casablanca.lon +"&lang=ar"+"&units=metric"+ "&appid=" + WEATHER_API_KEY
